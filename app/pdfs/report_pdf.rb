...
class ReportPdf < Prawn::Document
  ...
  def advert_rows
    [['#', @advert.id],['Title',@advert.title ],[ 'Description', @advert.description ], ['Name', @advert.name], ['Surname', @advert.surname],['Email', @advert.email],['Mobile', @advert.mobile],['Address',@advert.address ],['Image', @advert.image_file_name ]]
